...
# Format: version -> {error_correction_level -> [EC codewords per block, G1 blocks, G1 data codewords, G2 blocks, G2 data codewords]}
ECC_CODEWORDS_PER_BLOCK = {
    1: {'L': [7, 1, 19], 'M': [10, 1, 16], 'Q': [13, 1, 13], 'H': [17, 1, 9]},
    2: {'L': [10, 1, 34], 'M': [16, 1, 28], 'Q': [22, 1, 22], 'H': [28, 1, 16]},
    3: {'L': [15, 1, 55], 'M': [26, 1, 44], 'Q': [18, 2, 17], 'H': [22, 2, 13]},
    4: {'L': [20, 1, 80], 'M': [18, 2, 32], 'Q': [26, 2, 24], 'H': [16, 4, 9]},
    5: {'L': [26, 1, 108], 'M': [24, 2, 43], 'Q': [18, 2, 22, 2, 23], 'H': [22, 2, 15, 2, 16]},
    6: {'L': [18, 2, 68], 'M': [16, 4, 27], 'Q': [24, 4, 19], 'H': [28, 4, 15]},
    7: {'L': [20, 2, 78], 'M': [18, 4, 31], 'Q': [18, 2, 20, 4, 21], 'H': [26, 4, 13, 1, 14]},
    ...
    26: {'L': [28, 10, 114, 3, 115], 'M': [28, 19, 46, 4, 47], 'Q': [28, 28, 22, 6, 23], 'H': [30, 33, 16, 4, 17]},
